/**
 * Dados do IDoc ADRMAS - Mestre de Endereços
 * Gerado automaticamente de idocs/addresses.html
 */
...
export const SEGMENT_DEFINITIONS: Record<string, SegmentDefinition> = {
  ...
  E1BPAD1VL1: {
    description: 'Estrutura BAPI p/distribuição de categoria destinatário 1',
    fields: [
      {
        name: 'ADDRESS_ID',
  ...
  E1BPADTEL: {
    description: 'Estrutura BAPI p/nºs de telefone (admin.endereços central)',
    fields: [
      {
        name: 'COUNTRY',
  ...
  E1BPADFAX: {
    description: 'Estrutura BAPI p/nºs fax (administração endereços central)',
    fields: [
      {
        name: 'COUNTRY',
        description: 'País para nº de telefone/fax',
  ...
  E1BPADTLX: {
    description: 'Estrutura BAPI p/nºs telex (administração endereços central)',
    fields: [
      {
        name: 'COUNTRY',
        description: 'Chave do país',
  ...
  E1BPADSMTP: {
    description: 'Estrutura BAPI p/endereços e-mail (admin.endereços central)',
    fields: [
      {
        name: 'STD_NO',
        description: 'Endereço remetente standard neste tipo de comunicação',
  ...
  E1BPADX400: {
    description: 'Estrutura BAPI p/endereços X.400 (admin.endereços central)',
    fields: [
      {
        name: 'STD_NO',
        description: 'Endereço remetente standard neste tipo de comunicação',
  ...
  E1BPADSSF: {
    description: 'Estrutura BAPI p/endereços SSF (administr.central endereços)',
    fields: [
      {
        name: 'STD_NO',
        description: 'Endereço remetente standard neste tipo de comunicação',
  ...
  E1BPADSSF2: {
    description: 'Estrutura BAPI p/endereços SSF (admin.endereços central)',
    fields: [
      {
        name: 'SSFIDPART7',
        description: 'SSF nome signatário/receptor: 1ª-8ª parte',
  ...
  E1BPADURI: {
    description: 'Estrutura BAPI p/endereços URI (administr.central endereços)',
    fields: [
      {
        name: 'STD_NO',
        description: 'Endereço remetente standard neste tipo de comunicação',
  ...
  E1BPADURI2: {
    description: 'Estrutura BAPI p/endereços URI (admin.endereços central)',
    fields: [
      {
        name: 'URI_PART8',
        description: 'Universal Resource Identifier (URI): 1ª-8ª parte',
  ...
  E1BPADPAG: {
    description: 'Estrutura BAPI p/nºs pager (administração endereços central)',
    fields: [
      {
        name: 'COUNTRY',
        description: 'País para nº de telefone/fax',
...
export const ADDRESSES_DATA: IdocData = {
  ...
  description: 'IDoc ADRMAS para distribuição de dados mestres',
  tree: IDOC_TREE,
  segments: SEGMENT_DEFINITIONS,
};

export default ADDRESSES_DATA;
