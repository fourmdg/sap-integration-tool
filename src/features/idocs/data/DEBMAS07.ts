/**
 * Dados do IDoc DEBMAS07 - Mestre de Clientes
 * 37 segmentos, 684 campos
 * Gerado automaticamente a partir do HTML original
 */
import type { IdocData } from '../types';

export const DEBMAS_DATA: IdocData = {
  title: 'DEBMAS07 - Mestre de Clientes',
  ...
  tree: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              segment: 'E1KNVVH',
              description:
                'IDoc mestre de clientes dados comerciais: textos,\n                                cabeçalho',
              max: 9999999999,
              fields: [
                {
                  name: 'MSGFN',
        ...
        },
        {
          segment: 'E1KNBKM',
          description:
            'Master mestre clientes coordenadas bancárias e mestre\n                                bancos',
          max: 9999,
          fields: [
            {
              name: 'MSGFN',
        ...
        },
        {
          segment: 'E1KNKAM',
          description:
            'IDoc mestre de clientes adm.créditos, dados centrais\n                                (KNKA)',
          max: 1,
          fields: [
            {
              name: 'MSGFN',
              ...
              children: [
                {
                  segment: 'E1KNKKL',
                  description:
                    'IDoc mestre de clientes administração créditos: texto,\n                                linha',
                  max: 9999999999,
                  fields: [
                    {
                      name: 'MSGFN',
        ...
        },
        {
          segment: 'E1WRF5M',
          description:
            'Segmento p/ID centro/negociante da empresa cartão de\n                                crédito',
          max: 9999,
          fields: [
            {
              name: 'MSGFN',
