/**
 * Dados do IDoc MATMAS Retail - Materiais Varejo
 * Gerado automaticamente de idocs/materials-retail.html
 */
...
export const SEGMENT_DEFINITIONS: Record<string, SegmentDefinition> = {
  E1BPE1MATHEAD: {
    description: 'Transf.dados varejo - segmento cabeçalho com info controle',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1VARKEY: {
    description: 'Transf.dados varejo - lista das variantes para mat.genérico',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1AUSPRT: {
    description: 'Transferência de dados Retail - avaliação de características',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1AUSPRTX: {
    description: 'Transf.dados varejo - barra de seleção para BAPIE1AUSPRT',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MARART: {
    description: 'Transf.dados varejo - dados de material a nível de mandante',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
      ...
      {
        name: 'ROUND_UP_RULE_EXPIRATION_DATE',
        description: 'Regra de arredondamento para cálculo DV',
        type: 'CHAR(000001)',
      },
      {
        name: 'PROD_COMPOSITION_ON_PACKAGING',
  ...
  E1BPE1MARART1: {
    ...
    fields: [
      ...
      {
        name: 'PREPACK_GENERIC_MATL_EXTERNAL',
        description: 'Nº extenso material (futuro desenvolvimento) p/campo PREPA',
        type: 'CHAR(000040)',
      },
      {
        name: 'PREPACK_GENERIC_MATL_VERSION',
        description: 'Nº da versão (futuro desenvolvimento) para campo PREPACK_GEN',
        type: 'CHAR(000010)',
      },
      {
  ...
  E1BPE1MARARTX: {
    description: 'Transf.dados varejo - barra de seleção para BAPIE1MARART',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MARAEXTRT: {
    description: 'Transf.dados Retail - dados do cliente a nível de mandante',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MARAEXTRTX: {
    description: 'Transf.dados Retail - barra de seleção para BAPIE1MARAEXTRT',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MAW1RTX: {
    description: 'Transf.dados varejo - barra de seleção para BAPIE1MAW1RT',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MARCRT: {
    description: 'Transf.dados varejo - dados de material a nível de centro',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
      ...
      {
        name: 'MRP_RELEVANCY_DEP_REQUIREMENTS',
        description: 'Relevância MRP para necessidades dependentes',
        type: 'CHAR(000001)',
      },
      {
        name: 'AVAIL_CHECK_ALL_PROJ_SEGMENTS',
  ...
  E1BPE1MARCRTX: {
    description: 'Transf.dados varejo - barra de seleção para BAPIE1MARCRT',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MARCEXTRT: {
    description: 'Transf.dados Retail - dados do cliente a nível de centro',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MARCEXTRTX: {
    description: 'Transf.dados Retail - barra de seleção para BAPIE1MARCEXTRT',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MPGDRT: {
    description: 'Transf.dados varejo - dados de planejamento preliminar',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MPGDRTX: {
    description: 'Transf.dados varejo - barra de seleção para BAPIE1MPGDRT',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MARDRT: {
    description: 'Transf.dados varejo - dados de material a nível de depósito',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MARDRTX: {
    description: 'Transf.dados varejo - barra de seleção para BAPIE1MARDRT',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MARDEXTRT: {
    description: 'Transf.dados Retail - dados do cliente a nível de depósito',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MARDEXTRTX: {
    description: 'Transf.dados Retail - barra de seleção para BAPIE1MARDEXTRT',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MARMRTX: {
    description: 'Transf.dados varejo - barra de seleção para BAPIE1MARMRT',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MAMTRT: {
    description: 'Transf.dados varejo - textos de material dependentes da UM',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MALGRTX: {
    description: 'Transf.dados varejo - barra de seleção para BAPIE1MALGRT',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MBEWRTX: {
    description: 'Transf.dados Retail - barra de seleção para BAPIE1MBEWERT',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MBEWEXTRT: {
    description: 'Transf.dados Retail - dados de avaliação do cliente',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MBEWEXTRTX: {
    description: 'Transf.dados Retail - barra de seleção para BAPIE1MBEWEXTRT',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MLGNRTX: {
    description: 'Transf.dados varejo - barra de seleção para BAPIE1MLGNRT',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MLGNEXTRT: {
    description: 'Transf.dados Retail - dados sistema depósito do cliente',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MLGNEXTRTX: {
    description: 'Transf.dados Retail - barra de seleção para BAPIE1MLGNEXTRT',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MLGTRTX: {
    description: 'Transf.dados varejo - barra de seleção para BAPIE1MLGTRT',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MLGTEXTRT: {
    description: 'Transf.dados Retail - dados tipo de depósito do cliente',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MLGTEXTRTX: {
    description: 'Transf.dados Retail - barra de seleção para BAPIE1MLGTEXTRT',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MVKERTX: {
    description: 'Transf.dados varejo - barra de seleção para BAPIE1MVKERT',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1MVKEEXTRTX: {
    description: 'Transf.dados Retail - barra de seleção para BAPIE1MVKEEXTRT',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1WLK2RTX: {
    description: 'Transf.dados varejo - barra de seleção para BAPIE1WLK2RT',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1WLK2EXTRTX: {
    description: 'Transf.dados Retail - barra de seleção para BAPIE1WLK2EXTRT',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1WRKKEY: {
    description: 'Transf.dados varejo - lista dos centros ident.atualizados',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1LGOKEY: {
    description: 'Transf.dados varejo - lista dos depósitos ident.atualizados',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1VTLKEY: {
    description: 'Transf.dados varejo - lista canais de vendas ident.atualiz.',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1LGNKEY: {
    description: 'Transf.dados varejo - lista dos sistemas dep.ident.atualiz.',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1LGTKEY: {
    description: 'Transf.dados varejo - lista dos tipos depósito ident.atual.',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
  ...
  E1BPE1BWAKEY: {
    description: 'Transf.dados varejo - lista tipos de avaliação ident.atual.',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
...
export const MATERIALS_RETAIL_DATA: IdocData = {
  title: 'MATMAS Retail - Materiais Varejo',
  description: 'IDoc MATMAS Retail para distribuição de dados mestres',
  tree: IDOC_TREE,
  segments: SEGMENT_DEFINITIONS,
};

export default MATERIALS_RETAIL_DATA;
