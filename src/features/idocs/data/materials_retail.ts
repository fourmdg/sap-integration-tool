/**
 * Dados do IDoc ARTMAS - Materials Retail
...
export const MATERIALS_RETAIL_DATA: IdocData = {
  title: 'ARTMAS - Materials Retail',
  description: 'IDoc para distribuição de dados mestres de materiais de varejo',
  tree: [
    {
      ...
      max: 1,
      fields: [
        { name: 'FUNCTION', description: 'Função', type: 'CHAR(000003)' },
        { name: 'MATERIAL', description: 'Nº do material', type: 'CHAR(000018)' },
        { name: 'MATL_TYPE', description: 'Tipo de material', type: 'CHAR(000004)' },
        { name: 'MATL_GROUP', description: 'Grupo de mercadorias', type: 'CHAR(000009)' },
        { name: 'MATL_CAT', description: 'Ctg.material', type: 'CHAR(000002)' },
        { name: 'CHAR_PROF', description: 'Perfil da característica', type: 'CHAR(000018)' },
        { name: 'REF_MATL', description: 'Material-modelo', type: 'CHAR(000018)' },
        {
          name: 'BASIC_VIEW',
        ...
        { name: 'POS_VIEW', description: 'Código: considerar visão "POS"', type: 'CHAR(000001)' },
        {
          name: 'CK_NO_RNGE',
        ...
        { name: 'NO_APPL_LOG', description: 'Não escrever log de aplicação', type: 'CHAR(000001)' },
        {
          name: 'NO_CHANGE_DOC',
    ...
    },
    {
      ...
      fields: [
        { name: 'FUNCTION', description: 'Função', type: 'CHAR(000003)' },
        { name: 'MATERIAL', description: 'Nº do material', type: 'CHAR(000018)' },
        { name: 'VARIANT', description: 'Nº de variante', type: 'CHAR(000018)' },
        {
          name: 'MATERIAL_EXTERNAL',
          description: 'Nº de material longo para o campo MATERIAL',
          type: 'CHAR(000040)',
        ...
        { name: 'VARIANT_LONG', description: 'Nº de variante', type: 'CHAR(000040)' },
      ],
      children: [],
    },
    {
      ...
      fields: [
        ...
        { name: 'CHAR_NAME', description: 'Nome da característica', type: 'CHAR(000030)' },
        { name: 'CHAR_VALUE', description: 'Valor da característica', type: 'CHAR(000030)' },
        {
          name: 'MATERIAL_EXTERNAL',
          description: 'Nº de material longo para o campo MATERIAL',
          type: 'CHAR(000040)',
        ...
        { name: 'CHAR_VALUE_LONG', description: 'Valor da característica', type: 'CHAR(000070)' },
      ],
      children: [],
    },
    {
    ...
    },
    {
      ...
      fields: [
        { name: 'FUNCTION', description: 'Função', type: 'CHAR(000003)' },
        { name: 'MATERIAL', description: 'Nº do material', type: 'CHAR(000018)' },
        { name: 'CREATED_ON', description: 'Data de criação', type: 'DATS(000008)' },
        {
          name: 'CREATED_BY',
          description: 'Nome do responsável que adicionou o objeto',
          type: 'CHAR(000012)',
        },
        { name: 'LAST_CHNGE', description: 'Data da última modificação', type: 'DATS(000008)' },
        {
          name: 'CHANGED_BY',
        ...
        { name: 'OLD_MAT_NO', description: 'Nº material antigo', type: 'CHAR(000018)' },
        { name: 'BASE_UOM', description: 'Unidade de medida básica', type: 'UNIT(000003)' },
        {
          name: 'BASE_UOM_ISO',
          description: 'Unidade de medida básica no código ISO',
          type: 'CHAR(000003)',
        },
        { name: 'PO_UNIT', description: 'Unidade de medida do pedido', type: 'UNIT(000003)' },
        {
          name: 'PO_UNIT_ISO',
        ...
        { name: 'SIZE_DIM', description: 'Tamanho/dimensão', type: 'CHAR(000032)' },
        {
          name: 'BASIC_MATL',
        ...
        { name: 'PUR_VALKEY', description: 'Chave de valores de Compras', type: 'CHAR(000004)' },
        { name: 'NET_WEIGHT', description: 'Peso líquido', type: 'QUAN(000015)' },
        { name: 'CONTAINER', description: 'Instrução de recipiente', type: 'CHAR(000002)' },
        { name: 'STOR_CONDS', description: 'Condições de estocagem', type: 'CHAR(000002)' },
        {
          name: 'TEMP_CONDS',
          description: 'Código para a condição de temperatura',
          type: 'CHAR(000002)',
        },
        { name: 'TRANS_GRP', description: 'Grupo de transporte', type: 'CHAR(000004)' },
        { name: 'HAZ_MAT_NO', description: 'Nº substância perigosa', type: 'CHAR(000018)' },
        { name: 'DIVISION', description: 'Setor de atividade', type: 'CHAR(000002)' },
        { name: 'COMPETITOR', description: 'Concorrente', type: 'CHAR(000010)' },
        {
          name: 'QTY_GR_GI',
          description: 'Qtd.: determinação do número notas acompanhamento a imprimir',
          type: 'QUAN(000015)',
        },
        { name: 'PROC_RULE', description: 'Norma de suprimento', type: 'CHAR(000001)' },
        { name: 'SUP_SOURCE', description: 'Fonte de suprimento', type: 'CHAR(000001)' },
        { name: 'SEASON', description: 'Ctg.sazonal', type: 'CHAR(000004)' },
        { name: 'LABEL_TYPE', description: 'Tipo de etiquetagem', type: 'CHAR(000002)' },
        { name: 'LABEL_FORM', description: 'Forma da etiqueta', type: 'CHAR(000002)' },
        { name: 'PROD_HIER', description: 'Hierarquia de produtos', type: 'CHAR(000018)' },
        { name: 'CAD_ID', description: 'Código CAD', type: 'CHAR(000001)' },
        { name: 'ALLOWED_WT', description: 'Peso admissível da embalagem', type: 'QUAN(000015)' },
        {
          name: 'PACK_WT_UN',
        ...
        { name: 'ALLWD_VOL', description: 'Volume de embalagem admissível', type: 'QUAN(000015)' },
        {
          name: 'PACK_VO_UN',
        ...
        { name: 'VAR_ORD_UN', description: 'UM pedido variável ativa', type: 'CHAR(000001)' },
        {
          name: 'BATCH_MGMT',
          description: 'Código para administração em lote obrigatória',
          type: 'CHAR(000001)',
        },
        { name: 'SH_MAT_TYP', description: 'Tipo de material de embalagem', type: 'CHAR(000004)' },
        {
          name: 'FILL_LEVEL',
          description: 'Nível de preenchimento (por volume)',
          type: 'DEC(000004)',
        },
        { name: 'STACK_FACT', description: 'Fator de empilhamento', type: 'INT2(000006)' },
        {
          name: 'MAT_GRP_SM',
          description: 'Grupo de materiais material de embalagem',
          type: 'CHAR(000004)',
        },
        { name: 'AUTH_GROUP', description: 'Grupo de autorizações', type: 'CHAR(000004)' },
        { name: 'QM_PROCMNT', description: 'QM no suprimento está ativo', type: 'CHAR(000001)' },
        { name: 'CATPROFILE', description: 'Perfil do catálogo', type: 'CHAR(000009)' },
        { name: 'MINREMLIFE', description: 'Tempo de validade restante', type: 'DEC(000006)' },
        { name: 'SHELF_LIFE', description: 'Prazo de validade', type: 'DEC(000006)' },
        { name: 'STOR_PCT', description: 'Percentagem para armazenagem', type: 'DEC(000004)' },
        { name: 'VALID_FROM', description: 'Data de início da validade', type: 'DATS(000008)' },
        { name: 'DELN_DATE', description: 'Data da liquidação', type: 'DATS(000008)' },
        { name: 'SAESON_YR', description: 'Exercício sazonal', type: 'CHAR(000004)' },
        { name: 'PRICE_BAND', description: 'Tipo de faixa de preço', type: 'CHAR(000002)' },
        {
          name: 'EMPTIESBOM',
          description: 'Código: lista técnica de vasilhames',
          type: 'CHAR(000001)',
        },
        { name: 'EXTMATLGRP', description: 'Grupo de mercadorias externo', type: 'CHAR(000018)' },
        { name: 'CONF_MATL', description: 'Material configurável geral', type: 'CHAR(000018)' },
        { name: 'PR_REF_MAT', description: 'Mat.ref.p/prç.', type: 'CHAR(000018)' },
        {
          name: 'PUR_STATUS',
        ...
        { name: 'CONT_UNIT', description: 'Unidade de medida conteúdo', type: 'UNIT(000003)' },
        {
          name: 'CONT_UNIT_ISO',
          description: 'Unidade de medida de conteúdo em code ISO',
          type: 'CHAR(000003)',
        },
        { name: 'NET_CONT', description: 'Conteúdo líquido', type: 'QUAN(000015)' },
        { name: 'COMPPRUNIT', description: 'Preço de comparação', type: 'DEC(000006)' },
        { name: 'GROSS_CONT', description: 'Conteúdo bruto', type: 'QUAN(000015)' },
        {
          name: 'PRPROFVAR',
        ...
        { name: 'SEASMATCAT', description: 'Coleção em uma época', type: 'CHAR(000002)' },
        {
          name: 'HAZMATPROF',
          description: 'Perfil para código de mercadoria perigosa',
          type: 'CHAR(000003)',
        },
        { name: 'HIGH_VISC', description: 'Código: de alta viscosidade', type: 'CHAR(000001)' },
        { name: 'LOOSEORLIQ', description: 'Código: a granel / líquido', type: 'CHAR(000001)' },
        {
          name: 'CLOSED_BOX',
        ...
        { name: 'BASIC_MATL_NEW', description: 'Material básico', type: 'CHAR(000048)' },
        {
      ...
      children: [
        {
          ...
          fields: [
            ...
            { name: 'BRAND_ID', description: 'Marca', type: 'CHAR(000004)' },
            {
              name: 'FIBER_CODE_1',
            ...
            { name: 'PILFERABLE', description: 'Com risco de roubo', type: 'CHAR(000001)' },
            {
            ...
            { name: 'HANDLING_INDICATOR', description: 'Código de manuseio', type: 'CHAR(000004)' },
            {
              name: 'HAZ_MAT_RELEVANT',
              description: 'Relevante para substância perigosa',
              type: 'CHAR(000001)',
            },
            { name: 'HU_TYPE', description: 'Tipo de unidade comercial', type: 'CHAR(000004)' },
            {
            ...
            { name: 'MATFRGTGRP', description: 'Grupo de frete de material', type: 'CHAR(000008)' },
            { name: 'QUARANTINE_PERIOD', description: 'Quarentena', type: 'QUAN(000004)' },
            {
            ...
            { name: 'PCKGING_SMARTFORM', description: 'Nome do formulário', type: 'CHAR(000030)' },
            { name: 'ADJUST_PROFILE', description: 'Perfil de ajuste', type: 'CHAR(000003)' },
            {
    ...
    },
    {
      ...
      fields: [
        { name: 'FUNCTION', description: 'Função', type: 'CHAR(000003)' },
        { name: 'MATERIAL', description: 'Nº do material', type: 'CHAR(000018)' },
        { name: 'REPL_LIST', description: 'Tipo de lista de sortimento', type: 'CHAR(000001)' },
        {
          name: 'SERV_AGRT',
          description: 'Estipulação de serviço para um material do comércio',
          type: 'CHAR(000002)',
        },
        { name: 'ABC_ID', description: 'Código ABC', type: 'CHAR(000001)' },
        { name: 'PUR_GROUP', description: 'Grupo de compradores', type: 'CHAR(000003)' },
        { name: 'SALES_UNIT', description: 'Unidade de venda', type: 'UNIT(000003)' },
        {
          name: 'SALES_UNIT_ISO',
          description: 'Unidade de venda em code ISO',
          type: 'CHAR(000003)',
        },
        { name: 'ISSUE_UNIT', description: 'Unidade de medida de saída', type: 'UNIT(000003)' },
        {
          name: 'ISSUE_UNIT_ISO',
        ...
        { name: 'LOADINGGRP', description: 'Grupo de carregamento', type: 'CHAR(000004)' },
        { name: 'ASSORT_LEV', description: 'Nível de sortimento', type: 'CHAR(000002)' },
        { name: 'ASSORTPRIO', description: 'Prioridade de sortimento ext.', type: 'CHAR(000001)' },
        {
          name: 'LI_PROC_ST',
        ...
        { name: 'VAL_CLASS', description: 'Classe de avaliação', type: 'CHAR(000004)' },
        {
          name: 'COMM_CODE',
          description: 'Código das mercadorias / nº code import.p/comércio exterior',
          type: 'CHAR(000017)',
        },
        { name: 'VAL_MARGIN', description: 'Margem de avaliação', type: 'DEC(000009)' },
        {
          name: 'COUPON_PROFILE',
    ...
    },
    {
      ...
      fields: [
        { name: 'FUNCTION', description: 'Função', type: 'CHAR(000003)' },
        { name: 'MATERIAL', description: 'Nº do material', type: 'CHAR(000018)' },
        { name: 'LANGU', description: 'Código de idioma', type: 'LANG(000001)' },
        {
          name: 'LANGU_ISO',
          description: 'Código de idiomas SAP de 2 dígitos',
          type: 'CHAR(000002)',
        },
        { name: 'MATL_DESC', description: 'Texto breve de material', type: 'CHAR(000040)' },
        {
          name: 'MATERIAL_EXTERNAL',
          description: 'Nº de material longo para o campo MATERIAL',
          type: 'CHAR(000040)',
    ...
    },
    {
      ...
      fields: [
        { name: 'FUNCTION', description: 'Função', type: 'CHAR(000003)' },
        { name: 'MATERIAL', description: 'Nº do material', type: 'CHAR(000018)' },
        { name: 'PLANT', description: 'Centro', type: 'CHAR(000004)' },
        {
          name: 'DEL_FLAG',
        ...
        { name: 'ABC_ID', description: 'Código ABC', type: 'CHAR(000001)' },
        { name: 'CRIT_PART', description: 'Código: peça crítica', type: 'CHAR(000001)' },
        { name: 'PUR_GROUP', description: 'Grupo de compradores', type: 'CHAR(000003)' },
        { name: 'ISSUE_UNIT', description: 'Unidade de medida de saída', type: 'UNIT(000003)' },
        {
          name: 'ISSUE_UNIT_ISO',
        ...
        { name: 'MRP_TYPE', description: 'Tipo de MRP', type: 'CHAR(000002)' },
        { name: 'MRP_CTRLER', description: 'Planejador MRP', type: 'CHAR(000003)' },
        {
          name: 'PLND_DELRY',
        ...
        { name: 'PERIOD_IND', description: 'Código de período', type: 'CHAR(000001)' },
        { name: 'ASSY_SCRAP', description: 'Refugo do conjunto em %', type: 'DEC(000007)' },
        {
          name: 'LOTSIZEKEY',
          description: 'Chave de cálculo do tamanho do lote no MRP',
          type: 'CHAR(000002)',
        },
        { name: 'PROC_TYPE', description: 'Tipo de suprimento', type: 'CHAR(000001)' },
        { name: 'SPPROCTYPE', description: 'Tipo de suprimento especial', type: 'CHAR(000002)' },
        { name: 'REORDER_PT', description: 'Ponto de reabastecimento', type: 'QUAN(000015)' },
        { name: 'SAFETY_STK', description: 'Estoque de segurança', type: 'QUAN(000015)' },
        { name: 'MINLOTSIZE', description: 'Tamanho mínimo do lote', type: 'QUAN(000015)' },
        { name: 'MAXLOTSIZE', description: 'Tamanho máximo do lote', type: 'QUAN(000015)' },
        { name: 'FIXED_LOT', description: 'Tamanho fixo do lote', type: 'QUAN(000015)' },
        {
          name: 'ROUND_VAL',
          description: 'Valor de arredondamento da quantidade pedida',
          type: 'QUAN(000015)',
        },
        { name: 'MAX_STOCK', description: 'Estoque máximo', type: 'QUAN(000015)' },
        {
          name: 'ORD_COSTS',
        ...
        { name: 'DISCONTINU', description: 'Código de obsolescência', type: 'CHAR(000001)' },
        { name: 'EFF_O_DAY', description: 'Data de expiração', type: 'DATS(000008)' },
        { name: 'FOLLOW_UP', description: 'Material subsequente', type: 'CHAR(000018)' },
        {
          name: 'GRP_REQMTS',
        ...
        { name: 'SM_KEY', description: 'Chave de prazos para tempos buffer', type: 'CHAR(000003)' },
        { name: 'BACKFLUSH', description: 'Código: baixa por explosão', type: 'CHAR(000001)' },
        { name: 'INHSEPRODT', description: 'Tempo de produção interna', type: 'DEC(000004)' },
        { name: 'STGEPERIOD', description: 'Período máximo de armazenamento', type: 'DEC(000006)' },
        {
          name: 'STGE_PD_UN',
        ...
        { name: 'REPLACE_PT', description: 'Peça de reposição', type: 'CHAR(000001)' },
        {
          name: 'QUAL_INSP',
        ...
        { name: 'QUOTAUSAGE', description: 'Utilização da quotização', type: 'CHAR(000001)' },
        { name: 'SERV_LEVEL', description: 'Grau de atendimento', type: 'DEC(000005)' },
        { name: 'SPLIT_IND', description: 'Código de divisão', type: 'CHAR(000001)' },
        {
          name: 'AVAILCHECK',
          description: 'Grupo de verificação para verificação de disponibilidade',
          type: 'CHAR(000002)',
        },
        { name: 'FY_VARIANT', description: 'Variante de exercício', type: 'CHAR(000002)' },
        {
          name: 'CORR_FACT',
        ...
        { name: 'PROFIT_CTR', description: 'Centro de lucro', type: 'CHAR(000010)' },
        { name: 'PPC_PL_CAL', description: 'Calendário de planejamento PCP', type: 'CHAR(000003)' },
        {
          name: 'REP_MANUF',
          description: 'Código: produção repetitiva permitida',
          type: 'CHAR(000001)',
        },
        { name: 'PL_TI_FNCE', description: 'Horizonte de planejamento fixo', type: 'NUMC(000003)' },
        { name: 'CONSUMMODE', description: 'Modo de compensação', type: 'CHAR(000001)' },
        {
          name: 'BWD_CONS',
        ...
        { name: 'ISS_ST_LOC', description: 'Depósito de produção', type: 'CHAR(000004)' },
        { name: 'MRP_GROUP', description: 'Grupo MRP', type: 'CHAR(000004)' },
        { name: 'COMP_SCRAP', description: 'Refugo de componentes em %', type: 'DEC(000007)' },
        { name: 'CERT_TYPE', description: 'Categoria de certificado', type: 'CHAR(000004)' },
        { name: 'CYCLE_TIME', description: 'Tempo do ciclo de trabalho', type: 'DEC(000004)' },
        { name: 'COVPROFILE', description: 'Perfil de cobertura', type: 'CHAR(000003)' },
        {
          name: 'CO_PA_FLD',
        ...
        { name: 'SERNO_PROF', description: 'Perfil de nºs série', type: 'CHAR(000004)' },
        { name: 'REPMANPROF', description: 'Perfil produção repetitiva', type: 'CHAR(000004)' },
        {
          name: 'NEG_STOCKS',
          description: 'Estoques negativos admitidos no centro',
          type: 'CHAR(000001)',
        },
        { name: 'QM_RGMTS', description: 'Sistema QM exigido do fornecedor', type: 'CHAR(000004)' },
        { name: 'PLNG_CYCLE', description: 'Ciclo MRP', type: 'CHAR(000003)' },
        { name: 'ROUND_PROF', description: 'Perfil de arredondamento', type: 'CHAR(000004)' },
        {
          name: 'REFMATCONS',
          description: 'Material de referência para consumo',
          type: 'CHAR(000018)',
        },
        { name: 'REFPLTCONS', description: 'Centro referência - consumo', type: 'CHAR(000004)' },
        {
          name: 'D_TO_REF_M',
        ...
        { name: 'MILIT_ID', description: 'Código: mercadoria militar', type: 'CHAR(000001)' },
        {
          name: 'INSP_INT',
        ...
        { name: 'BULK_MAT', description: 'Código: material a granel', type: 'CHAR(000001)' },
        { name: 'CC_FIXED', description: 'Código CC fixo', type: 'CHAR(000001)' },
        {
          name: 'DETERM_GRP',
        ...
        { name: 'UNIT_GROUP', description: 'Grupo unidade medida', type: 'CHAR(000004)' },
        {
          name: 'PVALIDFROM',
          description: 'Data, a partir da qual status mat.espec.centro é válido',
          type: 'DATS(000008)',
        },
        { name: 'SERV_LEV_R', description: 'Grau de atendimento SAM', type: 'CHAR(000001)' },
        { name: 'MATFRGTGRP', description: 'Grupo de frete de material', type: 'CHAR(000008)' },
        {
          name: 'HANDLG_GRP',
        ...
        { name: 'CFOP_CAT', description: 'Material: categoria CFOP', type: 'CHAR(000002)' },
        {
          name: 'EU_LIST_NO',
        ...
        { name: 'PROD_PROF', description: 'Perfil de controle de produção', type: 'CHAR(000006)' },
        {
          name: 'MAT_GRP_TRANS',
        ...
        { name: 'SETUP_TIME_PROC', description: 'Tempos de preparação', type: 'DEC(000007)' },
        { name: 'PROCESSING_TIME', description: 'Tempo de processamento', type: 'DEC(000007)' },
        { name: 'BASE_QTY_PROC', description: 'Quantidade básica', type: 'QUAN(000015)' },
        { name: 'INTEROP_TIME', description: 'Tempo de transição', type: 'DEC(000007)' },
        { name: 'PROD_UNIT', description: 'Unidade de medida de produção', type: 'UNIT(000003)' },
        {
          name: 'PROD_UNIT_ISO',
          description: 'Unidade de medida de produção no código ISO',
          type: 'CHAR(000003)',
        },
        { name: 'VARIANCE_KEY', description: 'Chave de desvio', type: 'CHAR(000006)' },
        { name: 'ALTERNATIVE_BOM', description: 'Lista técnica alternativa', type: 'CHAR(000002)' },
        { name: 'BOM_USAGE', description: 'Utilização lista técnica', type: 'CHAR(000001)' },
        {
          name: 'TASK_LIST_GRP_NO',
          description: 'Chave do grupo de listas de tarefas',
          type: 'CHAR(000008)',
        },
        { name: 'GROUP_COUNTER', description: 'Numerador de grupos', type: 'CHAR(000002)' },
        { name: 'TASK_LIST_TYPE', description: 'Tipo de roteiro', type: 'CHAR(000001)' },
        {
          name: 'SPEC_PROC_TYPE',
        ...
        { name: 'NO_COSTING', description: 'Não calcular custos', type: 'CHAR(000001)' },
        {
      ...
      children: [
        {
          ...
          fields: [
            ...
            { name: 'MIN_TROC', description: 'Cobertura mínima planejada', type: 'NUMC(000003)' },
            { name: 'MAX_TROC', description: 'Cobertura máxima planejada', type: 'NUMC(000003)' },
            { name: 'TARGET_STOCK', description: 'Estoque teórico', type: 'QUAN(000015)' },
            {
              name: 'SEGMENTATION_STRATEGY',
              description: 'Estratégia de segmentação',
              type: 'CHAR(000008)',
            ...
            { name: 'VARIANT_GROUP', description: 'Grupo de variantes', type: 'CHAR(000002)' },
            {
            ...
            { name: 'FOLLOW_UP_LONG', description: 'Material subsequente', type: 'CHAR(000040)' },
            {
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'MATERIAL', description: 'Nº do material', type: 'CHAR(000018)' },
        { name: 'PLANT', description: 'Centro', type: 'CHAR(000004)' },
        { name: 'FORE_PROF', description: 'Perfil de previsão', type: 'CHAR(000004)' },
        { name: 'MODEL_SI', description: 'Código de seleção de modelo', type: 'CHAR(000001)' },
        { name: 'MODEL_SP', description: 'Processo de seleção de modelo', type: 'CHAR(000001)' },
        {
          name: 'PARAM_OPT',
          description: 'Código para otimização de parâmetros',
          type: 'CHAR(000001)',
        },
        { name: 'OPTIM_LEV', description: 'Nível de otimização', type: 'CHAR(000001)' },
        { name: 'INITIALIZE', description: 'Código de inicialização', type: 'CHAR(000001)' },
        { name: 'FORE_MODEL', description: 'Modelo de previsão', type: 'CHAR(000001)' },
        {
          name: 'ALPHA_FACT',
        ...
        { name: 'TRACKLIMIT', description: 'Limiar de aviso', type: 'DEC(000007)' },
        { name: 'FORE_DATE', description: 'Data da última previsão', type: 'DATS(000008)' },
        { name: 'HIST_VALS', description: 'Núm.dos períodos históricos', type: 'DEC(000004)' },
        { name: 'INIT_PDS', description: 'Nº de períodos para inicialização', type: 'DEC(000004)' },
        {
          name: 'SEASON_PDS',
        ...
        { name: 'FORE_PDS', description: 'Nº de períodos de previsão', type: 'DEC(000004)' },
        { name: 'FIXED_PDS', description: 'Períodos fixos', type: 'DEC(000004)' },
        { name: 'WTG_GROUP', description: 'Grupo de ponderação', type: 'CHAR(000002)' },
        {
          name: 'MATERIAL_EXTERNAL',
          description: 'Nº de material longo para o campo MATERIAL',
          type: 'CHAR(000040)',
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'FORE_VALUE', description: 'Valor de previsão', type: 'QUAN(000015)' },
        {
          name: 'CORR_VALUE',
          description: 'Valor corrigido p/valor de previsão',
          type: 'QUAN(000015)',
        },
        { name: 'SEAS_INDEX', description: 'Índice sazonal', type: 'DEC(000007)' },
        {
          name: 'CVALUE_FXD',
          description: 'Código: valor de previsão fixado',
          type: 'CHAR(000001)',
        },
        { name: 'EXPOST_VAL', description: "Valor de previsão 'ex post'", type: 'QUAN(000015)' },
        {
          name: 'VAL_RATIO',
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'CONS_VALUE', description: 'Valor de consumo', type: 'QUAN(000015)' },
        { name: 'CORR_VALUE', description: 'Valor de consumo corrigido', type: 'QUAN(000015)' },
        {
          name: 'VAL_RATIO',
          description: 'Relação valor original : valor corrigido',
          type: 'DEC(000007)',
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'MATERIAL', description: 'Nº do material', type: 'CHAR(000018)' },
        { name: 'PLANT', description: 'Centro', type: 'CHAR(000004)' },
        { name: 'PLNG_MATL', description: 'Material planejado', type: 'CHAR(000018)' },
        { name: 'PLNG_PLANT', description: 'Centro de planejamento', type: 'CHAR(000004)' },
        {
          name: 'CONVFACTOR',
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'MATERIAL', description: 'Nº do material', type: 'CHAR(000018)' },
        { name: 'PLANT', description: 'Centro', type: 'CHAR(000004)' },
        { name: 'STGE_LOC', description: 'Depósito', type: 'CHAR(000004)' },
        {
          name: 'DEL_FLAG',
          description: 'Marcar mat.para eliminação a nível de depósito',
          type: 'CHAR(000001)',
        },
        { name: 'MRP_IND', description: 'Código MRP depósito', type: 'CHAR(000001)' },
        {
          name: 'SPEC_PROC',
        ...
        { name: 'STGE_BIN', description: 'Posição no depósito', type: 'CHAR(000010)' },
        { name: 'PICKG_AREA', description: 'Área de picking para lean WM', type: 'CHAR(000003)' },
        {
          name: 'MATERIAL_EXTERNAL',
          description: 'Nº de material longo para o campo MATERIAL',
          type: 'CHAR(000040)',
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'EAN_UPC', description: 'Nº europeu do artigo (EAN)', type: 'CHAR(000018)' },
        {
          name: 'EAN_CAT',
          description: 'Ctg.de número do nº europeu do artigo',
          type: 'CHAR(000002)',
        },
        { name: 'LENGTH', description: 'Comprimento', type: 'QUAN(000015)' },
        { name: 'WIDTH', description: 'Largura', type: 'QUAN(000015)' },
        { name: 'HEIGHT', description: 'Altura', type: 'QUAN(000015)' },
        {
          name: 'UNIT_DIM',
        ...
        { name: 'VOLUME', description: 'Volume', type: 'QUAN(000015)' },
        { name: 'VOLUMEUNIT', description: 'Unidade de volume', type: 'UNIT(000003)' },
        {
          name: 'VOLUMEUNIT_ISO',
          description: 'Unidade de volume no code ISO',
          type: 'CHAR(000003)',
        },
        { name: 'GROSS_WT', description: 'Peso bruto', type: 'QUAN(000015)' },
        { name: 'UNIT_OF_WT', description: 'Unidade de peso', type: 'UNIT(000003)' },
        {
          name: 'UNIT_OF_WT_ISO',
          description: 'Unidade de peso no código ISO',
          type: 'CHAR(000003)',
        },
        { name: 'UNIT', description: 'Unidade de medida para a exibição', type: 'UNIT(000003)' },
        {
          name: 'UNIT_ISO',
        ...
        { name: 'CAPACITY_USAGE', description: 'Consumo da capacidade', type: 'DEC(000017)' },
        {
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'SEGMENT', description: 'Valor de segmentação', type: 'CHAR(000016)' },
      ],
      children: [],
    },
    {
      ...
      fields: [
        ...
        { name: 'VENDOR_NO', description: 'Nº conta do fornecedor', type: 'CHAR(000010)' },
        { name: 'EAN_UPC', description: 'Nº europeu do artigo (EAN)', type: 'CHAR(000018)' },
        {
          name: 'MAIN_EAN',
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'LAYOUT_MOD', description: 'Módulo layout', type: 'CHAR(000010)' },
        {
          name: 'SORT_SEQ',
        ...
        { name: 'SHELF_BOARD_NUMBER', description: 'Seção da prateleira', type: 'NUMC(000010)' },
        {
          name: 'FRONT',
        ...
        { name: 'PRES_QNT', description: 'Qtd.apresentação', type: 'QUAN(000015)' },
        { name: 'LAYMOD_VER', description: 'Versão de um módulo layout', type: 'NUMC(000004)' },
        {
          name: 'MATERIAL_EXTERNAL',
          description: 'Nº de material longo para o campo MATERIAL',
          type: 'CHAR(000040)',
        ...
        { name: 'EXCLUSION', description: 'Flag de exclusão', type: 'CHAR(000001)' },
      ],
      children: [],
    },
    {
    ...
    },
    {
      ...
      fields: [
        { name: 'FUNCTION', description: 'Função', type: 'CHAR(000003)' },
        { name: 'MATERIAL', description: 'Nº do material', type: 'CHAR(000018)' },
        { name: 'VAL_AREA', description: 'Área de avaliação', type: 'CHAR(000004)' },
        { name: 'VAL_TYPE', description: 'Tipo de avaliação', type: 'CHAR(000010)' },
        {
          name: 'DEL_FLAG',
          description: 'Marcação p/eliminar todos os dads.mat.de um tipo avaliação',
          type: 'CHAR(000001)',
        },
        { name: 'PRICE_CTRL', description: 'Código de controle de preço', type: 'CHAR(000001)' },
        {
          name: 'MOVING_PR',
          description: 'Preço médio móvel/preço interno periódico',
          type: 'DEC(000025)',
        },
        { name: 'STD_PRICE', description: 'Prç.standard', type: 'DEC(000025)' },
        { name: 'PRICE_UNIT', description: 'Unidade preço', type: 'DEC(000006)' },
        { name: 'VAL_CLASS', description: 'Classe de avaliação', type: 'CHAR(000004)' },
        {
          name: 'PR_CTRL_PP',
        ...
        { name: 'STD_PR_PY', description: 'Preço standard do ano precedente', type: 'DEC(000025)' },
        {
          name: 'PR_UNIT_PY',
        ...
        { name: 'VAL_CAT', description: 'Categoria de avaliação', type: 'CHAR(000001)' },
        { name: 'FUTURE_PR', description: 'Preço futuro', type: 'DEC(000025)' },
        { name: 'VALID_FROM', description: 'Início da validade do preço', type: 'DATS(000008)' },
        {
          name: 'TAXPRICE_1',
        ...
        { name: 'LIFO_FIFO', description: 'Relevante para LIFO/FIFO', type: 'CHAR(000001)' },
        { name: 'POOLNUMBER', description: 'Nº pool para avaliação LIFO', type: 'CHAR(000004)' },
        {
          name: 'TAXPRICE_2',
        ...
        { name: 'MATL_USAGE', description: 'Utilização de material', type: 'CHAR(000001)' },
        { name: 'MAT_ORIGIN', description: 'Origem de material', type: 'CHAR(000001)' },
        { name: 'IN_HOUSE', description: 'Produção interna', type: 'CHAR(000001)' },
        {
          name: 'TAX_CML_UN',
        ...
        { name: 'ORIG_MAT', description: 'Origem referida a material', type: 'CHAR(000001)' },
        {
          name: 'OVERHEAD_GRP',
        ...
        { name: 'PLND_PRICE', description: 'Preço planejado futuro', type: 'DEC(000025)' },
        { name: 'PLNDPRICE1', description: 'Preço planejado futuro 1', type: 'DEC(000025)' },
        { name: 'PLNDPRICE2', description: 'Preço planejado futuro 2', type: 'DEC(000025)' },
        { name: 'PLNDPRICE3', description: 'Preço planejado futuro 3', type: 'DEC(000025)' },
        {
          name: 'PLNDPRDATE1',
    ...
    },
    {
      ...
      fields: [
        { name: 'FUNCTION', description: 'Função', type: 'CHAR(000003)' },
        { name: 'MATERIAL', description: 'Nº do material', type: 'CHAR(000018)' },
        { name: 'WHSE_NO', description: 'Nºdepósito/complexo de depósito', type: 'CHAR(000003)' },
        {
          name: 'DEL_FLAG',
        ...
        { name: 'UNITTYPE_1', description: '1. tipo de unidade de depósito', type: 'CHAR(000003)' },
        { name: 'UNITTYPE_2', description: '2. tipo de unidade de depósito', type: 'CHAR(000003)' },
        { name: 'UNITTYPE_3', description: '3. tipo de unidade de depósito', type: 'CHAR(000003)' },
        { name: 'WM_UNIT', description: 'Unidade de medida WM', type: 'UNIT(000003)' },
        {
          name: 'WM_UNIT_ISO',
        ...
        { name: 'BLOCK_STGE', description: 'Código depósito em bloco', type: 'CHAR(000002)' },
        {
          name: 'MSG_TO_IM',
        ...
        { name: 'CAPY_USAGE', description: 'Consumo de capacidade', type: 'DEC(000013)' },
        {
          name: 'PROCURE_UN',
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'MATERIAL', description: 'Nº do material', type: 'CHAR(000018)' },
        { name: 'WHSE_NO', description: 'Nºdepósito/complexo de depósito', type: 'CHAR(000003)' },
        { name: 'STGE_TYPE', description: 'Tipo de depósito', type: 'CHAR(000003)' },
        {
          name: 'DEL_FLAG',
        ...
        { name: 'STGE_BIN', description: 'Posição no depósito', type: 'CHAR(000010)' },
        { name: 'MAX_SB_QTY', description: 'Qtd.máxima posiç.no dep.', type: 'QUAN(000015)' },
        { name: 'MIN_SB_QTY', description: 'Qtd.mínima posiç.no dep.', type: 'QUAN(000015)' },
        { name: 'CTRL_QTY', description: 'Quantidade de manejo', type: 'QUAN(000015)' },
        { name: 'REPLEN_QTY', description: 'Quantidade de reabastecimento', type: 'QUAN(000015)' },
        { name: 'PICK_AREA', description: 'Área de picking', type: 'CHAR(000003)' },
        { name: 'ROUND_UNIT', description: 'Qtd.arredond.', type: 'QUAN(000015)' },
        {
          name: 'MATERIAL_EXTERNAL',
          description: 'Nº de material longo para o campo MATERIAL',
          type: 'CHAR(000040)',
    ...
    },
    {
      ...
      fields: [
        { name: 'FUNCTION', description: 'Função', type: 'CHAR(000003)' },
        { name: 'MATERIAL', description: 'Nº do material', type: 'CHAR(000018)' },
        { name: 'SALES_ORG', description: 'Organização de vendas', type: 'CHAR(000004)' },
        { name: 'DISTR_CHAN', description: 'Canal de distribuição', type: 'CHAR(000002)' },
        {
          name: 'DEL_FLAG',
          description: 'Código: marcar mat.para eliminação a nível canal de vendas',
          type: 'CHAR(000001)',
        },
        { name: 'MATL_STATS', description: 'Grupo estatístico material', type: 'CHAR(000001)' },
        { name: 'REBATE_GRP', description: 'Grupo de bônus', type: 'CHAR(000002)' },
        { name: 'COMM_GROUP', description: 'Grupo de comissões', type: 'CHAR(000002)' },
        { name: 'CASH_DISC', description: 'Código: com direito a desconto', type: 'CHAR(000001)' },
        {
          name: 'SAL_STATUS',
        ...
        { name: 'DELY_UNIT', description: 'Unidade de medida da remessa', type: 'QUAN(000015)' },
        {
          name: 'DELY_UOM',
        ...
        { name: 'DELYG_PLNT', description: 'Centro fornecedor', type: 'CHAR(000004)' },
        { name: 'PROD_HIER', description: 'Hierarquia de produtos', type: 'CHAR(000018)' },
        { name: 'PR_REF_MAT', description: 'Mat.ref.p/prç.', type: 'CHAR(000018)' },
        { name: 'MAT_PR_GRP', description: 'Grupo de materiais', type: 'CHAR(000002)' },
        {
          name: 'ACCT_ASSGT',
          description: 'Grupo de classificação contábil - material',
          type: 'CHAR(000002)',
        },
        { name: 'MATL_GRP_1', description: 'Grupo de material 1', type: 'CHAR(000003)' },
        { name: 'MATL_GRP_2', description: 'Grupo de material 2', type: 'CHAR(000003)' },
        { name: 'MATL_GRP_3', description: 'Grupo de materiais 3', type: 'CHAR(000003)' },
        { name: 'MATL_GRP_4', description: 'Grupo de material 4', type: 'CHAR(000003)' },
        { name: 'MATL_GRP_5', description: 'Grupo de material 5', type: 'CHAR(000003)' },
        { name: 'ASSORT_LEV', description: 'Nível de sortimento', type: 'CHAR(000002)' },
        { name: 'ASSORTPRIO', description: 'Prioridade de sortimento ext.', type: 'CHAR(000001)' },
        {
          name: 'LI_PROC_ST',
        ...
        { name: 'PROD_ATT_1', description: 'Código atributo de produto 1', type: 'CHAR(000001)' },
        { name: 'PROD_ATT_2', description: 'Código atributo de produto 2', type: 'CHAR(000001)' },
        { name: 'PROD_ATT_3', description: 'Código atributo de produto 3', type: 'CHAR(000001)' },
        { name: 'PROD_ATT_4', description: 'Código atributo de produto 4', type: 'CHAR(000001)' },
        { name: 'PROD_ATT_5', description: 'Código atributo de produto 5', type: 'CHAR(000001)' },
        { name: 'PROD_ATT_6', description: 'Código atributo de produto 6', type: 'CHAR(000001)' },
        { name: 'PROD_ATT_7', description: 'Código atributo de produto 7', type: 'CHAR(000001)' },
        { name: 'PROD_ATT_8', description: 'Código atributo de produto 8', type: 'CHAR(000001)' },
        { name: 'PROD_ATT_9', description: 'Código atributo de produto 9', type: 'CHAR(000001)' },
        { name: 'PROD_ATT10', description: 'Código atributo de produto 10', type: 'CHAR(000001)' },
        {
          name: 'LIST_ST_FR',
          description: 'Data a partir da qual se efetua a catalogação na filial',
          type: 'DATS(000008)',
        ...
        { name: 'UNIT_GROUP', description: 'Grupo unidade medida', type: 'CHAR(000004)' },
        { name: 'ROUND_PROF', description: 'Perfil de arredondamento', type: 'CHAR(000004)' },
        { name: 'PRICE_FIXING', description: 'Código para preço tabelado', type: 'CHAR(000001)' },
        {
          name: 'VAR_SALES_UN',
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'PLANT', description: 'Centro de comercialização', type: 'CHAR(000004)' },
        { name: 'NO_REP_KEY', description: 'Sem tecla de repetição', type: 'CHAR(000001)' },
        { name: 'PRICE_REQD', description: 'Preço necessário', type: 'CHAR(000001)' },
        {
          name: 'SELL_ST_FR',
          description: 'Data a partir da qual se vende na filial',
          type: 'DATS(000008)',
        ...
        { name: 'DISC_ALLWD', description: 'Descontos admitidos', type: 'CHAR(000001)' },
        { name: 'SCALES_GRP', description: 'Grupo de balanças', type: 'CHAR(000004)' },
        {
          name: 'MATERIAL_EXTERNAL',
          description: 'Nº de material longo para o campo MATERIAL',
          type: 'CHAR(000040)',
    ...
    },
    {
      ...
      fields: [
        { name: 'FUNCTION', description: 'Função', type: 'CHAR(000003)' },
        { name: 'APPLOBJECT', description: 'Textos: objeto de aplicação', type: 'CHAR(000010)' },
        { name: 'TEXT_NAME', description: 'Nome', type: 'CHAR(000070)' },
        { name: 'TEXT_ID', description: 'ID de texto', type: 'CHAR(000004)' },
        { name: 'LANGU', description: 'Código de idioma', type: 'LANG(000001)' },
        {
          name: 'LANGU_ISO',
          description: 'Código de idiomas SAP de 2 dígitos',
        ...
        { name: 'FORMAT_COL', description: 'Coluna de formato', type: 'CHAR(000002)' },
        { name: 'TEXT_LINE', description: 'Linha de texto', type: 'CHAR(000132)' },
        { name: 'MATERIAL', description: 'Nº do material', type: 'CHAR(000018)' },
        {
          name: 'MATERIAL_EXTERNAL',
          description: 'Nº de material longo para o campo MATERIAL',
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'FIBER_PART', description: 'Quota de fibras em porcentagem', type: 'NUMC(000003)' },
        {
          name: 'SCIENTIFIC_NAME_CODE',
          description: 'Código para nome científico',
          type: 'CHAR(000003)',
        },
        { name: 'PRINT_FLAG', description: 'Imprimir', type: 'CHAR(000001)' },
        {
          name: 'PSM_CODE',
          description: 'Código para administração de espécies protegidas',
          type: 'CHAR(000002)',
        },
        { name: 'DOKNR', description: 'Nº documento', type: 'CHAR(000025)' },
        { name: 'DOKAR', description: 'Tipo de documento', type: 'CHAR(000003)' },
        { name: 'DOKTL', description: 'Documento parcial', type: 'CHAR(000003)' },
        { name: 'DOKVR', description: 'Versão do documento', type: 'CHAR(000002)' },
        { name: 'COUNTRY', description: 'Chave do país', type: 'CHAR(000003)' },
        { name: 'COUNTRY_ISO', description: 'Código do país em código ISO', type: 'CHAR(000002)' },
      ],
      children: [],
    },
    {
      ...
      fields: [
        { name: 'FUNCTION', description: 'Função', type: 'CHAR(000003)' },
        { name: 'MATERIAL', description: 'Nº do material', type: 'CHAR(000018)' },
        { name: 'SALESORG', description: 'Organização de vendas', type: 'CHAR(000004)' },
        { name: 'DISTR_CHAN', description: 'Canal de distribuição', type: 'CHAR(000002)' },
        { name: 'REQ_SEGMENT', description: 'Segmento de necessidade', type: 'CHAR(000016)' },
        {
          name: 'SAL_STATUS',
          description: 'Status do material específica da linha de vendas',
          type: 'CHAR(000002)',
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'STOCK_SEGMENT', description: 'Segmento de estoque', type: 'CHAR(000016)' },
        { name: 'CONF_MATL', description: 'Material configurável geral', type: 'CHAR(000018)' },
        { name: 'VOLUME', description: 'Volume', type: 'QUAN(000015)' },
        { name: 'GROSS_WT', description: 'Peso bruto', type: 'QUAN(000015)' },
        { name: 'NET_WEIGHT', description: 'Peso líquido', type: 'QUAN(000015)' },
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'VALUATION_TYPE', description: 'Tipo de avaliação', type: 'CHAR(000010)' },
      ],
      children: [],
    },
    {
      ...
      fields: [
        ...
        { name: 'REQ_SEGMENT', description: 'Segmento de necessidade', type: 'CHAR(000016)' },
        { name: 'MATERIAL', description: 'Nº do material', type: 'CHAR(000018)' },
        { name: 'SEASON_YR', description: 'Ano de época', type: 'CHAR(000004)' },
        { name: 'SEASON', description: 'Época', type: 'CHAR(000004)' },
        { name: 'COLLECTION', description: 'Coleção de moda', type: 'CHAR(000002)' },
        { name: 'THEME', description: 'Tema de moda', type: 'CHAR(000004)' },
        { name: 'SEASON1', description: 'Tipo de época 1', type: 'CHAR(000001)' },
        { name: 'SEASON2', description: 'Tipo de época 2', type: 'CHAR(000001)' },
        { name: 'SEASON3', description: 'Tipo de época 3', type: 'CHAR(000001)' },
        {
          name: 'ARTICLE_SEASON_DESC',
          description: 'Descrição da época do artigo',
          type: 'CHAR(000080)',
        },
        { name: 'SEASON_INDICATOR', description: 'Código de época', type: 'CHAR(000001)' },
        { name: 'CONF_MATL', description: 'Material configurável geral', type: 'CHAR(000018)' },
      ],
      children: [],
    },
