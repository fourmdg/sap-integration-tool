/**
 * Dados do IDoc QMATMAS - QM de Materiais
 * Gerado automaticamente de idocs/material-qm.html
 */
...
export const SEGMENT_DEFINITIONS: Record<string, SegmentDefinition> = {
  E1BP1001004_QMAT: {
    description: 'Dds.controle QM material (QMAT) ALE distribuição com BAPI',
    fields: [
      {
        name: 'FUNCTION',
        description: 'Função',
...
export const MATERIAL_QM_DATA: IdocData = {
  title: 'QMATMAS - QM de Materiais',
  description: 'IDoc QMATMAS para distribuição de dados mestres',
  tree: IDOC_TREE,
  segments: SEGMENT_DEFINITIONS,
};

export default MATERIAL_QM_DATA;
